...
public void adminCanNotCreateWithInvalidDataTest() {
    ...
    //ШАГ 3 : проверка текста алерта "username: Username must be between 3 and 15 characters"

    Alert alert = switchTo().alert();

    assertThat(alert.getText().contains("username: Username must be between 3 and 15 characters"));
